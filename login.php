<?php
   ...
   if(isset($_POST['login'])) {
        ...
        $sql = "SELECT * FROM absen WHERE username='$username' AND password = '$password'
        ";
...
<body>
    <div class="Login-box">
        ...
        <form action="login.php" method="post">
            <div class="usr">
                <input type="text" placholder="username" name="Username"   /><br><br>
                <input type="password" placholder="password" name="password" />
            </div><br><br><br>
            <div>
                <button type="submit" name="login" class="btn-login">Masuk mang</button>
            </div><br><br><br><br>
            <div class="forgot">
